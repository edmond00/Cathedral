...
/// Source: heart organ score (0–4, see <see cref="HeartOrgan.HeartPart"/>).
/// Formula: score * 50 / 4 → 0 % … 50 %.
/// </summary>
public sealed class YouthfulnessStat : DerivedStat
{
    ...
    // Heart's single part maxes at 4; score 4 → 50 %.
    protected override int CalculateValue(int sourceScore) => sourceScore * 50 / 4;
