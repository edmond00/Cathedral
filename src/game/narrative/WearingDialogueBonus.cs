...
{
    /// <summary>Bonus dialogue dice <paramref name="member"/>'s dress earns with <paramref name="social"/>.</summary>
    ...
    /// bonus is three is less useful than knowing which three things are earning it.
    /// </summary>
