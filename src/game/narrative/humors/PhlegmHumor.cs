...
/// No vital heat contribution and no transmuting effect; the roll passes through unchanged.
/// </summary>
public sealed class PhlegmHumor : BodyHumor
{
    ...
    public override TransmutingVirtue? TransmutingVirtue => new NullVirtue();
}
