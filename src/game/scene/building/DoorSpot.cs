...
/// <summary>Lock state of a <see cref="DoorSpot"/>.</summary>
public enum DoorState { Locked, Unlocked }

/// <summary>
/// A door connecting two areas. Subclass of <see cref="Spot"/>.
///
/// Lock semantics:
...
///
/// The DoorSpot should be added to both <see cref="FrontArea"/>.Spots and
/// <see cref="BackArea"/>.Spots so it is visible and interactable from either side.
/// </summary>
